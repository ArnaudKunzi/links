...
## R
  * Packages
    ...
    * [data.validator](https://github.com/Appsilon/data.validator) creates interactive data validation reports on the fly. Very useful in projects in which data keeps changing to ensure everything is always in order at the data preparation stage or for data monitoring purposes.
    * Power calculation:
